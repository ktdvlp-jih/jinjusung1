...
// 쿼리 전송
//전체 데이터 수 
$t_sql = "select count(*) from noticeBoard;"; // 쿼리문 작성 // row갯수를 셈 행의 갯수
                    ...
                    <div class="section2_information_in">
                        ...
                        <table>
                            <tr>
                                ...
                                <th style="width: 55%; text-align:left;">제목</th>
                            ...
                            $sql = "select*from noticeBoard order by idx desc limit $start, $list_num";
                            // echo "$sql";
                            $result = mysqli_query($con, $sql);
                            ...
                            ?>
                                <tr>
                                    <td>
                                        <p><?php echo $array["idx"] ?></p>
                                    </td>
                                    <td>
                                        <p style="text-align:left"><a href="jinjusung_sub2_participation_yard_noticeboard_the.php?idx=<?php echo $array["idx"]; ?>"><?php echo $array["title"]; ?></a></p>
                                    </td>
                                    <td>
                                        <p> <?php echo $array["uwrite"] ?> </p>
                                    </td>
                                    <td>
                                        <p> <?php echo $array["reg_date"] ?> </p>
                                    </td>
                                    <td>
