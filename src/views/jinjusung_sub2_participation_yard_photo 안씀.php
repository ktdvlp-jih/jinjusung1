...
// 쿼리 전송
//전체 데이터 수 
$t_sql = "select count(*) from photo;"; // 쿼리문 작성 // row갯수를 셈 행의 갯수

// $ss = "select * from photo;"; // 쿼리문 작성 // row갯수를 셈 행의 갯수
// $num = mysqli_num_rows($result);
...
$count = "update photo set count=count+1 where idx=$idx";
...
<head>
    ...
    <title>진주성 참여마당 포토갤러리</title>
    <script>
    </script>

    <link rel="stylesheet" type="text/css" href="../../dist/css/jinjusung_sub2_participation_yard_photo1.css">
            ...
            <div class="section2_box">
                ...
                <article class="section2_information">
                    ...
                    <div class="section2_information_in">
                        ...
                        //"select*from $photo order by idx desc limit $start, $list_num";
                        $sql = "select * from photo order by idx asc limit $start, $list_num";
                        // echo "$sql";
                        $result = mysqli_query($con, $sql);
                        ...
                        ?>
                            <a href="jinjusung_sub0_photo_the.php?idx=<?php echo $array["idx"]; ?>">
...
<script type="text/javascript" src="../../dist/js/jinjusung_sub2_participation_yard_photo.js"></script>
<!-- <dl class="section2_information_padding">
                            <dt id="aside_box_photo1"><a href="#">사진</a></dt>
                            <dd><span>진주성에서</span></dd>
                            <dd>우리나라 문화재가 이렇게 많이 숨어있는지 몰랐어요.</dd>
                        </dl>

                        <dl>
                            <dt id="aside_box_photo2"><a href="#">사진</a></dt>
                            <dd><span>가족이랑 같이</span></dd>
                            <dd>유등 축제한다길래 진주성에 들려봤어요!</dd>
                        </dl> -->