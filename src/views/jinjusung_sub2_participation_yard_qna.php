...
// $sql = "select * from qna;";
// $sql = "select * from qna ;";
// $sql = "select * from qna order by idx desc;";

// $result = mysqli_query($con, $sql);
// 쿼리 전송
//전체 데이터 수 
$t_sql = "select count(*) from qna;"; // 쿼리문 작성 // row갯수를 셈 행의 갯수
// $ss = "select * from qna;"; // 쿼리문 작성 // row갯수를 셈 행의 갯수
// $num = mysqli_num_rows($result);
            ...
            <div class="section2_box">
                ...
                <article class="section2_information">
                    ...
                    <div class="section2_information_in">
                            ...
                            ?>
                                <tr>
                                    <td>
                                        ...
                                        <a href="jinjusung_sub2_participation_yard_qna_the.php?idx=<?php echo $array["idx"]; ?>">

                                            <p> <?php echo "[" . $array["idx"] . "]" . " " . $array["title"]; ?></p>
                                            <p><?php echo $array["contents"] ?></p>
                                            <br>
                                            <p class="p_i"><?php echo " 작성자 " . $array["uid"], " / 등록일 " . $array["reg_date"], " / 조회수 " . $array["count"] ?></p>
                                        </a>
                        ...
                        <a href="jinjusung_sub2_participation_yard_qna_text.php" class="text_button">글쓰기</a>
