...
// 쿼리 전송
//전체 데이터 수 
$t_sql = "select count(*) from faq;"; // 쿼리문 작성 // row갯수를 셈 행의 갯수
// $ss = "select * from noticeBoard;"; // 쿼리문 작성 // row갯수를 셈 행의 갯수
...
$count = "update faq set count=count+1 where idx=$idx";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../dist/css/jinjusung_sub2_participation_yard_noticeboard.css">
...
<body>
    ...
    <section class="section2_wrap">
        <div class="section2" style="height: 769px;">
            ...
            <div class="section2_box">
                <div class="section2_text">
                    <div class="text2">
                        <h3>참여마당</h3>
                        <p><span>참여마당</span><span>공지사항</span>자주하는질문(FAQ)</p>
                    </div>
                </div>
                <div class="section2_line"></div>

                <article class="section2_information">
                    <h2>진주성이야기_공지사항_자주하는질문 (FAQ)</h2>
                    <div class="section2_information_in">
                        ...
                        <table>
                            ...
                            // $sql = "select*from faq order by idx desc limit $start, $list_num";
                            $sql = "select*from faq order by idx asc limit $start, $list_num";
                            // echo "$sql";
                            ...
                            ?>
                                ...
                                <tr class="tr_l" id="tr_l<?php echo $array['idx'] ?>">
                                    <td class="td_c">
                                        <span class="td_s">Q</span>
                                    </td>
                                    <td style="width:80%">
                                        <p>[질문]<?php echo $array["title"] ?></p>
                                    </td>
                                    <td class="td_i">
                                        <i class="the_icon_p"></i>
                                    </td>
                                </tr>
                                <tr class="tr_la" id="tr_l<?php echo $array['idx'] ?>a">
                                    <td class="td_c">
                                        <span class="td_s2">A</span>
                                    </td>
                                    <td style="width:80%">
                                        <p>[답변]<?php echo $array["title"] ?></p>
                                        <p><?php echo $array["contents"] ?></p>

                                    </td>
                                    <td class="td_i">
                                        <i class="the_icon_n"></i>
                                    </td>
                                </tr>
                        ...
                        <!-- <div class="the" style="cursor: pointer;" onclick="location.href='<?php echo $phpself . $num_max += 1 ?>'">
                            <a href="<?php $phpself ?>?page=<?php echo $page + 1 ?>" target="_self"><span class="the_span">더보기 </span><span class="the_img"></span></a>
                        </div> -->
