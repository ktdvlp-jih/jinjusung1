...
// echo $total_page;
// echo "$e_pageNum";
$p_sql = "select * from human where idx=$idx-1";
$n_sql = "select * from human where idx=$idx+1";
                ...
                <article class="section2_information">
                    ...
                    <div class="section2_information_in">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="3" class="td_img"><img src="../../dist/css/sub0_history_human/human<?php echo $array["idx"] ?>.jpg" alt="" width="636px" height="390px"></td>
                            </tr>
                            <tr>
                        ...
                        <a href="jinjusung_sub2_participation_yard_human.php" class="list_b">목록</a>
                    </div>
                </article>
            </div>
        </div>
