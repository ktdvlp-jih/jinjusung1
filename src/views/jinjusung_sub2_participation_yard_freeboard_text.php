        ...
        <div class="section2">
            ...
            <div class="section2_box">
                ...
                <div class="article_box">
                    <form action="jinjusung_sub2_participation_yard_freeboard_text_submit.php" method="POST" name="form_box" id="form_box">
                        <fieldset class="form_fieldset">
                            ...
                            <p style="text-align: end;"><label for="button_s"></label><button class="button_s" type="button" id="button_s" onclick="form_check()">확인</button> <label for="button_l"></label><button class="button_l" type="button" id="button_l" onclick="history.back()">목록</button></p>
                        </fieldset>
                    </form>
                </div>
            </div>
