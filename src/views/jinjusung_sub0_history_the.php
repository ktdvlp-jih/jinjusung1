...
// 조회수 증가
$count = "update history set count=count+1 where idx=$idx";
...
// echo $total_page;
// echo "$e_pageNum";
$p_sql = "select * from history where idx=$idx-1";
$n_sql = "select * from history where idx=$idx+1";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../dist/css/jinjusung_sub0_human_the.css">
                ...
                <article class="section2_information">
                    ...
                    <div class="section2_information_in">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="3" class="td_img">
                                    <img src="../../dist/css/sub0_history_history/history<?php echo $array["idx"] ?>.jpg" alt="" width="636px" height="390px">
                                </td>
                            </tr>
                            <tr>
                        ...
                        <a href="jinjusung_sub0_history.php" class="list_b">목록</a>
                    </div>
                </article>
            </div>
        </div>
