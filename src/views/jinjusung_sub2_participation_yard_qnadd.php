...
// 쿼리 전송
//전체 데이터 수 
$t_sql = "select count(*) from qna;"; // 쿼리문 작성 // row갯수를 셈 행의 갯수
...
$count = "update qna set count=count+1 where idx=$idx";
        ...
        <div class="section2" style="height: 769px;">
            ...
            <div class="section2_box">
                <div class="section2_text">
                    <div class="text2">
                        <h3>참여마당</h3>
                        <p><span>참여마당</span><span>공지사항</span>여행질문하기 (Q&amp;A)</p>
                    </div>
                </div>
                <div class="section2_line"></div>

                <article class="section2_information">
                    <h2>진주성이야기_공지사항_여행질문하기 (Q&amp;A)</h2>
                    <div class="section2_information_in">
                        ...
                        <table>
                            ...
                            $sql = "select*from qna order by idx asc limit $start, $list_num";
                            // echo "$sql";
