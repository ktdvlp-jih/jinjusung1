...
// 쿼리 전송
//전체 데이터 수 
$t_sql = "select count(*) from history;"; // 쿼리문 작성 // row갯수를 셈 행의 갯수
// $ss = "select * from history;"; // 쿼리문 작성 // row갯수를 셈 행의 갯수
// $num = mysqli_num_rows($result);
...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="../../dist/css/jinjusung_sub0_history.css"> -->
            ...
            <div class="section2_box">
                ...
                <article class="section2_information">
                    ...
                    <div class="section2_information_in">
                        ...
                        //"select*from $history order by idx desc limit $start, $list_num";
                        $sql = "select * from history order by idx asc limit $start, $list_num";
                        // echo "$sql";
                        $result = mysqli_query($con, $sql);
                        ...
                        ?>
                            <a href="jinjusung_sub0_history_the.php?idx=<?php echo $array["idx"]; ?>">
