...
// echo $total_page;
// echo "$e_pageNum";
$p_sql = "select * from qna where idx=$idx-1";
$n_sql = "select * from qna where idx=$idx+1";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../dist/css/jinjusung_sub2_participation_yard_freeboard_the.css">
            ...
            <div class="section2_box">
                ...
                <article class="section2_information">
                    ...
                    <div class="section2_information_in">
                        ...
                        <a href="jinjusung_sub2_participation_yard_qna.php" class="list_b">목록</a>
                    </div>
                </article>
            </div>
        </div>
